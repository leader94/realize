...
public class ViewUtils {
    ...
    public static int getSizeInDp(Context context, int size) {
        int sizeInDp = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, size, context.getResources().getDisplayMetrics());
        return sizeInDp;

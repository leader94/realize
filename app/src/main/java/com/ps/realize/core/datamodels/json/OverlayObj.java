...
public class OverlayObj {
    ...
    public OverlayObj(String id, String fileName, String localPath, String originalName, String originalExtn, String uploadUrl, boolean uploadPending) {
        this.id = id;
